...
my_img = cv2.imread('WhatsApp Image 2023-02-11 at 9.26.25 PM.jpeg',0) #0 means no color, 1 means color, -1 means unchanged
cv2.imwrite('grayscale.jpg',my_img)
new_img = imThreshold(my_img,155,255) 
# The function cv2.imshow() is used to display an image in a window.
thresholds =[50,100,155,200]

img = cv2.imread('WhatsApp Image 2023-02-11 at 9.26.25 PM.jpeg')
